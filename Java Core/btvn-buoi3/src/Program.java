...
public class Program {
    public static void main(String[] args) {
        ...
        // Gọi các phương thức trong các Exercise
        ...
        Exercise1.question10b(accounts);
        Exercise1.question11b(departments);
        Exercise1.question12b(departments);
        Exercise1.question13b(accounts);
        Exercise1.question14b(accounts);
        Exercise1.question15b();
