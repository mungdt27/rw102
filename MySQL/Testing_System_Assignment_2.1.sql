...
WHERE group_id IN (SELECT group_id FROM group_account WHERE join_date < '2019-12-20');
...
SELECT COUNT(*) AS 'Quantity of employee' 
FROM `account` WHERE department_id = 2;

-- Question 11: Lấy ra nhân viên có tên bắt đầu bằng chữ "D" và kết thúc bằng chữ "o" 
SELECT * FROM `account` WHERE user_name LIKE 'D%o';
...
UPDATE `account` SET full_name = "Nguyễn Bá Lộc", 
